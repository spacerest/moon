...
ui.selected_collage.set_negative_space(ui.image_store["blue"])

ui.selected_collage.set_positive_space(ui.image_store["white"])
ui.image_to_mask(DATE, DATE, alpha_values=4, mask_divisor=-40, prep_mask_divisor=255)
